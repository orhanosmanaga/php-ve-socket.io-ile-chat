...
kime = :kime");
    ...
    $karakter2=array(":)",":(");
    $emoji2=array("<img width='10px' height='10px' src='emoji_gul.png'>","<img width='10px' height='10px' src='emoji_mutsuz.png'>");
    $emojitarama2=str_replace($karakter2,$emoji2,$genelmesaj);
    if($genelkimden==$mesajatilan) {
        ?>
        <div id="mesajsol"><?= $emojitarama2 ?></div><br>
        <?php
    }
    if($genelkimden==$mesajatan){?>
        <div id="mesajsag"><?=$emojitarama2?></div><br>
